...
print(my_triangle.self2_check_angles()) # this is actually what they wanted
...
# 18 / 18 - Creating an instance
class Equilateral(Triangle):
  angle = 60
  def __init__(self, angle1, angle2, angle3):
    super().__init__(angle1, angle2, angle3) #this must match the parent class
